...
intake <- read_csv("data/open-play/clean/intake.csv.gz", show_col_types = FALSE)
diary <- read_csv("data/open-play/clean/daily.csv.gz", show_col_types = FALSE)
panel <- read_csv("data/open-play/clean/biweekly.csv.gz", show_col_types = FALSE)
